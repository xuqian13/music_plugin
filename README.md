...
[![版本](https://img.shields.io/badge/version-1.0.3-blue.svg)](https://github.com)
...
- ✅ 修复历史上的今天API格式变更导致的slice错误
  - 原因：API返回格式从 `{"data": [...]}` 变更为 `{"data": {"items": [...]}}`
  - 修复：兼容新旧两种API响应格式

**🔧 优化改进**
- ✅ 配置项描述更明确
  - `send_image` → "是否发送60秒新闻图片"
  - `send_text` → "是否发送60秒新闻文本"
